    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/pages/dashboard-queue-monitor.js',
                ...
                'resources/js/pages/tour-zip-status-poll.js',
                'resources/js/pages/queue-monitor-index.js',
                ...
                'resources/js/pages/booking_infomodal_nodes.js',
