        ...
        <div class="col-12">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
                ...
                <div class="d-flex align-items-center gap-2">
                    <x-admin.back-button :fallback="route('admin.tours.index')" :classes="['btn', 'btn-soft-secondary']"
                ...
                <div class="card panel-card border-primary border-top mb-3" data-panel-card>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <label class="form-label" for="name">Tour Name <span
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-select" required>
                                        @foreach($statuses as $s)
                                            <option value="{{ $s }}" @selected(old('status', $tour->status) == $s)>
                                                {{ ucfirst($s) }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="revision" id="revision" class="form-control"
                                        value="{{ old('revision', $tour->revision) }}" placeholder="e.g. v1.0">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="content" id="content" class="form-control"
                                rows="6">{{ old('content', $tour->content) }}</textarea>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="price" id="price" class="form-control"
                                        value="{{ old('price', $tour->price) }}" step="0.01" min="0">
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="duration_days" id="duration_days" class="form-control"
                                        value="{{ old('duration_days', $tour->duration_days) }}" min="1">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="max_participants" id="max_participants" class="form-control"
                                        value="{{ old('max_participants', $tour->max_participants) }}" min="1">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="featured_image" id="featured_image" class="form-control"
                                        value="{{ old('featured_image', $tour->featured_image) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="final_json" id="final_json" class="form-control font-monospace" rows="5"
                                placeholder='{"key": "value"}'>{!! old('final_json', is_array($tour->final_json) ? json_encode($tour->final_json, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) : $tour->final_json) !!}</textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="meta_description" id="meta_description" class="form-control"
                                rows="2">{{ old('meta_description', $tour->meta_description) }}</textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="meta_robots" id="meta_robots" class="form-control"
                                        value="{{ old('meta_robots', $tour->meta_robots) }}" placeholder="index, follow">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="og_title" id="og_title" class="form-control"
                                        value="{{ old('og_title', $tour->og_title) }}">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="og_image" id="og_image" class="form-control"
                                        value="{{ old('og_image', $tour->og_image) }}">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="twitter_title" id="twitter_title" class="form-control"
                                        value="{{ old('twitter_title', $tour->twitter_title) }}">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="twitter_image" id="twitter_image" class="form-control"
                                        value="{{ old('twitter_image', $tour->twitter_image) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="twitter_description" id="twitter_description" class="form-control"
                                rows="2">{{ old('twitter_description', $tour->twitter_description) }}</textarea>
                ...
                <div class="card panel-card border-warning border-top mb-3" data-panel-card>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="structured_data" id="structured_data" class="form-control font-monospace"
                                rows="5"
                                placeholder='{"@context": "https://schema.org", "@type": "TouristAttraction"}'>{{ old('structured_data', is_array($tour->structured_data) ? json_encode($tour->structured_data, JSON_PRETTY_PRINT) : $tour->structured_data) }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="custom_logo_footer" id="custom_logo_footer"
                                        class="form-control" accept="image/*"
                                        onchange="previewImage(event, 'footer_logo_preview')">
                                    <div class="mt-2">
                                        @if($tour->custom_logo_footer)
                                            <img id="footer_logo_preview"
                                                src="{{ Storage::disk('s3')->url($tour->custom_logo_footer) }}"
                                                alt="Footer Logo"
                                                style="max-width: 150px; max-height: 80px; border:1px solid #ddd; background:#fff; padding:2px;">
                                        @else
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="custom_name" id="custom_name" class="form-control"
                                        value="{{ old('custom_name', $tour->custom_name) }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="custom_email" id="custom_email" class="form-control"
                                        value="{{ old('custom_email', $tour->custom_email) }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="custom_mobile" id="custom_mobile" class="form-control"
                                        value="{{ old('custom_mobile', $tour->custom_mobile) }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="custom_type" id="custom_type" class="form-control"
                                        value="{{ old('custom_type', $tour->custom_type) }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <textarea name="custom_description" id="custom_description" class="form-control"
                                        rows="2">{{ old('custom_description', $tour->custom_description) }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea name="company_address" id="company_address" class="form-control"
                                    rows="2">{{ old('company_address', $tour->company_address) }}</textarea>
                                @error('company_address')<div class="text-danger">{{ $message }}</div>@enderror
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card panel-card border-danger border-top mb-3" data-panel-card>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="header_code" id="header_code" class="form-control font-monospace"
                                rows="4">{{ old('header_code', $tour->header_code) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="footer_code" id="footer_code" class="form-control font-monospace"
                                rows="4">{{ old('footer_code', $tour->footer_code) }}</textarea>
                    ...
                    <div class="card-body row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="footer_info_type" id="footer_info_type" class="form-select">
                                <option value="company" {{ old('footer_info_type', $tour->footer_info_type) == 'company' ? 'selected' : '' }}>Company</option>
                                <option value="agent" {{ old('footer_info_type', $tour->footer_info_type) == 'agent' ? 'selected' : '' }}>Agent</option>
                            </select>
