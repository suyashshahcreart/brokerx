                    ...
                    <nav aria-label="breadcrumb" class="mb-0">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('admin.photographer-visits.index') }}">Photographer Visits</a></li>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            ...
                            <dl class="row mb-0">
                                ...
                                <dd class="col-sm-8">
                                    {{ $photographerVisit->photographer->firstname }}
                                    {{ $photographerVisit->photographer->lastname }}
                                ...
                                <dd class="col-sm-8">
                                    <a href="{{ route('admin.bookings.show', $photographerVisit->booking) }}"
                                        class="text-decoration-none">
                                        #{{ $photographerVisit->booking->id }}
                                    </a>
                                    <div class="text-muted small">
                                        {{ $photographerVisit->booking->society_name ?? $photographerVisit->booking->address_area }}
                                    </div>
                                </dd>

                                <dt class="col-sm-4">Visit Date</dt>
                                <dd class="col-sm-8">
                                    {{ optional($photographerVisit->visit_date)->format('d M Y, h:i A') ?? '-' }}</dd>
                                ...
                                <dd class="col-sm-8">
                                    ...
                                    @endphp
                                    <span
                                        class="badge bg-{{ $color }}">{{ ucwords(str_replace('_', ' ', $photographerVisit->status)) }}</span>
                                </dd>
                        ...
                        <div class="col-lg-6">
                            ...
                            <dl class="row mb-0">
                                ...
                                <dd class="col-sm-8">{{ $photographerVisit->booking->propertyType?->name ?? '-' }} /
                                    {{ $photographerVisit->booking->propertySubType?->name ?? '-' }}</dd>

                                <dt class="col-sm-4">Location</dt>
                                <dd class="col-sm-8">
                                    {{ $photographerVisit->booking->city?->name ?? '-' }},
                                    {{ $photographerVisit->booking->state?->name ?? '-' }}
                            ...
                            <div class="col-lg-6">
                                <dl class="row mb-0">
                                    ...
                                    @if($photographerVisit->check_in_location)
                                        <dt class="col-sm-4">Location</dt>
                                        <dd class="col-sm-8">
                                            <a href="https://www.google.com/maps?q={{ $photographerVisit->check_in_location }}"
                                    ...
                                    @if($photographerVisit->check_in_metadata)
                                        ...
                                        <dd class="col-sm-8">{{ $photographerVisit->check_in_metadata['location_accuracy'] ?? '-' }}
                                            meters</dd>

                                        <dt class="col-sm-4">Location Source</dt>
                                        <dd class="col-sm-8">
                                            <span
                                                class="badge bg-secondary">{{ strtoupper($photographerVisit->check_in_metadata['location_source'] ?? 'Unknown') }}</span>
                                        </dd>
                                    @endif
                                    ...
                                    @if($photographerVisit->check_in_device_info)
                                        ...
                                        <dd class="col-sm-8"><small
                                                class="text-muted">{{ Str::limit($photographerVisit->check_in_device_info, 60) }}</small>
                                        </dd>
                                    @endif
                                    ...
                                    <div>
                                        ...
                                        <div class="border rounded p-2">
                                            <img src="{{ asset('storage/' . $photographerVisit->check_in_photo) }}"
                                                alt="Check-in Photo" class="img-fluid rounded"
                                ...
                                <dl class="row mb-0">
                                    ...
                                    @if($photographerVisit->checked_in_at && $photographerVisit->checked_out_at)
                                        ...
                                        <dd class="col-sm-8">
                                            ...
                                            @endphp
                                            <strong
                                                class="text-primary">{{ $hours > 0 ? "{$hours}h " : "" }}{{ $minutes }}m</strong>
                                        </dd>
                                    @endif

                                    @if($photographerVisit->photos_taken)
                                        <dt class="col-sm-4">Photos Taken</dt>
                                        <dd class="col-sm-8"><span class="badge bg-info fs-6">{{ $photographerVisit->photos_taken }}
                                                photos</span></dd>
                                    @endif
                                    ...
                                    @if($photographerVisit->check_out_location)
                                        <dt class="col-sm-4">Location</dt>
                                        <dd class="col-sm-8">
                                            <a href="https://www.google.com/maps?q={{ $photographerVisit->check_out_location }}"
                                                target="_blank" class="text-decoration-none">
                                    ...
                                    @if($photographerVisit->check_out_metadata)
                                        <dt class="col-sm-4">Location Accuracy</dt>
                                        <dd class="col-sm-8">
                                            {{ $photographerVisit->check_out_metadata['location_accuracy'] ?? '-' }} meters</dd>

                                        <dt class="col-sm-4">Location Source</dt>
                                        <dd class="col-sm-8">
                                            <span
                                                class="badge bg-secondary">{{ strtoupper($photographerVisit->check_out_metadata['location_source'] ?? 'Unknown') }}</span>
                                        </dd>
                                    @endif
                                    ...
                                    @if($photographerVisit->check_out_device_info)
                                        <dt class="col-sm-4">Device Info</dt>
                                        <dd class="col-sm-8"><small
                                                class="text-muted">{{ Str::limit($photographerVisit->check_out_device_info, 60) }}</small>
                                        </dd>
                                    @endif
                                    ...
                                    <div>
                                        ...
                                        <div class="border rounded p-2">
                                            <img src="{{ asset('storage/' . $photographerVisit->check_out_photo) }}"
                                                alt="Check-out Photo" class="img-fluid rounded"
                                                style="max-height: 300px; cursor: pointer;"
                                                onclick="window.open(this.src, '_blank')">
                                        </div>
                                    </div>
