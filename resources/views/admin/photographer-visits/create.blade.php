@extends('admin.layouts.vertical', ['title' => 'Create Photographer Visit', 'subTitle' => 'Management'])
    ...
    <div class="col-12">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
            <div>
                ...
                <h3 class="mb-0">Create Photographer Visit</h3>
            </div>
        ...
        <div class="card panel-card border-primary border-top" data-panel-card>
            <div class="card-header d-flex justify-content-between align-items-start flex-wrap gap-2">
                <div>
                    ...
                    <p class="text-muted mb-0">Schedule a photographer visit</p>
                </div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.photographer-visits.store') }}" class="needs-validation" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                                    ...
                                    <option value="checked_out" @selected(old('status')=='checked_out')>Checked Out</option>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea name="notes" id="notes" rows="4" 
                                    ...
                                    placeholder="Enter any notes or special instructions...">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('admin.photographer-visits.index') }}" class="btn btn-soft-secondary">
                            <i class="ri-close-line me-1"></i> Cancel
                        </a>
                        <button type="submit" class="btn btn-primary">
                            <i class="ri-save-line me-1"></i> Create Visit
                        </button>
                    </div>
                </form>
            </div>
