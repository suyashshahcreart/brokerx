@extends('admin.layouts.vertical', ['title' => 'Assign Booking to Photographer', 'subTitle' => 'Property'])
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
                ...
                <div>
                    <nav aria-label="breadcrumb" class="mb-0">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Assign Booking</li>
                        </ol>
                    </nav>
                    <h3 class="mb-0">Assign Booking to Photographer</h3>
                </div>
                <div>
            ...
            <div class="card panel-card border-primary border-top">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.booking-assignees.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex gap-2 justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="ri-check-line me-1"></i> Assign Booking
                            </button>
                        </div>
                    </form>
                </div>
