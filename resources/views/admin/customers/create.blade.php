...
<div class="row">
    ...
    <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="mb-1">
                                ...
                                <div id="social-links-container" data-links='{{ json_encode(old('social_link', [])) }}'>
                                        <!-- Existing social link pairs will be rendered here by JavaScript -->
        ...
        <!-- SEO settings card -->
        <div class="d-none card panel-card border-secondary border-top mt-3" data-panel-card>
            <div class="card-header d-flex justify-content-between align-items-start flex-wrap gap-2">
                <div>
...
@endsection
@section('script')
@vite(['resources/js/pages/customers-add.js'])
<style>
