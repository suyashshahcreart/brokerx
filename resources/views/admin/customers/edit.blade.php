            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.customer.update', $customer) }}" class="needs-validation" novalidate enctype="multipart/form-data">
                    ...
                    {{-- <div class="row">
                        <div class="col-md-4 col-6">
                            <div class="mb-1">
                                <label for="password" class="form-label mb-0">Password <small class="text-muted">(leave blank to keep current)</small></label>
                                <div class="input-group">
    ...
    if (profilePhotoInput && profilePhotoPreview) {
        profilePhotoInput.addEventListener('change', function() {
            ...
            if (file && file.type.startsWith('image/')) {
                ...
                const existing = profilePhotoPreviewImg.getAttribute('data-existing');
                if (existing) {
                    profilePhotoPreviewImg.src = existing;
                } else {
    ...
    if (coverPhotoInput && coverPhotoPreview) {
        coverPhotoInput.addEventListener('change', function() {
            ...
            if (file && file.type.startsWith('image/')) {
                ...
                const existing = coverPhotoPreviewImg.getAttribute('data-existing');
                if (existing) {
                    coverPhotoPreviewImg.src = existing;
                } else {
