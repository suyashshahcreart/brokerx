                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-sm" id="quickBookingStatus"
                                ...
                                <option value="confirmed" {{ $booking->status == 'confirmed' ? 'selected' : '' }}>
                                    Confirmed</option>
                                <option value="schedul_pending" {{ $booking->status == 'schedul_pending' ? 'selected' : '' }}>
                                    Schedule Pending
                                </option>
                                <option value="schedul_accepted" {{ $booking->status == 'schedul_accepted' ? 'selected' : '' }}>
                                    Schedule Accepted
                                </option>
                                <option value="schedul_decline" {{ $booking->status == 'schedul_decline' ? 'selected' : '' }}>
                                    Schedule Declined
                                </option>
                                <option value="reschedul_pending"
                                    {{ $booking->status == 'reschedul_pending' ? 'selected' : '' }}>
                                    Reschedule Pending
                                </option>
                                <option value="reschedul_accepted"
                                    {{ $booking->status == 'reschedul_accepted' ? 'selected' : '' }}>
                                    Reschedule Accepted
                                </option>
                                <option value="reschedul_decline"
                                    {{ $booking->status == 'reschedul_decline' ? 'selected' : '' }}>
                                    Reschedule Declined
                                </option>
                                <option value="reschedul_blocked"
                                    {{ $booking->status == 'reschedul_blocked' ? 'selected' : '' }}>
                                    Reschedule Blocked
                                </option>
                                <option value="schedul_assign" {{ $booking->status == 'schedul_assign' ? 'selected' : '' }}>
                                    Schedule
                                    Assigned
                                </option>
                                <option value="schedul_completed"
                                    {{ $booking->status == 'schedul_completed' ? 'selected' : '' }}>
                                    Schedule Completed
                                </option>
                                <option value="tour_pending" {{ $booking->status == 'tour_pending' ? 'selected' : '' }}>
                                    Tour Pending</option>
                                <option value="tour_completed" {{ $booking->status == 'tour_completed' ? 'selected' : '' }}>Tour
                                    Completed</option>
        ...
        @if(in_array($booking->status, ['schedul_pending', 'reschedul_pending']) && ($canApproval ?? false))
            ...
            <div class="col-12 col-md-6">
                <div class="card border">
                    ...
                    <div class="card-body p-2">
                        <div class="my-3">
                            <small class="text-muted d-block mb-1" style="font-size: 10px; font-weight: 600;">REQUESTED
                                DATE</small>
                        ...
                        @if($booking->booking_notes)
                            <div class="my-3">
                                <small class="text-muted d-block mb-1" style="font-size: 10px; font-weight: 600;">CUSTOMER
                                    NOTES</small>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <small class="d-block mb-1">
                                            <i class="ri-user-line me-1"></i>{{ $photographerAssignee->user->firstname }}
