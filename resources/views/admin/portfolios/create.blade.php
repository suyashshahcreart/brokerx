@extends('admin.layouts.vertical', ['title' => 'Create Portfolio', 'subTitle' => 'Management'])
        ...
        <div class="card panel-card border-primary border-top" data-panel-card>
            <div class="card-header d-flex justify-content-between align-items-start flex-wrap gap-2">
                <div>
                    ...
                    <p class="text-muted mb-0">Fill in portfolio information</p>
                </div>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.portfolios.store') }}" class="needs-validation" novalidate enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" rows="6" class="form-control @error('description') is-invalid @enderror" placeholder="Enter portfolio description">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
