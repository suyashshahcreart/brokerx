...
<head>
    ...
    <title>QR Analytics - PROP PIK</title>
                    ...
                    <div class="logo-section card h-100">
                        <div class="text-center">
                            <div class="card-content">
                                ...
                                <div class="domain-display">qr.proppik.com</div>
                                
                                <p class="message-text">
                                    Please scan a PROP PIK QR code to experiences Global Web Virtual Reality .
                                </p>
                                <p class="message-text">
                                    Scan any PROP PIK QR code to get started Global Web Virtual Reality experiences.
                                </p>
                                ...
                                <div class="action-buttons">
                                    <div class="row g-2 align-items-stretch">
                                        ...
                                        <div class="col-12 col-sm-6 d-flex">
                                            <a href="https://www.proppik.com/" class="btn w-100 btn-secondary d-flex align-items-center justify-content-center" target="_blank" rel="noopener">
                                                <span>🏠</span>
