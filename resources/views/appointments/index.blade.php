                    ...
                    <div class="modal-content">
                        <form class="needs-validation" action="{{ route('appointments.store') }}" method="POST"
                            ...
                            <div class="modal-body px-3 pb-3 pt-0">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="alert alert-info mb-3">
                                                ...
                                                <strong>Scheduler:</strong> {{ $loggedInScheduler->name }}
                                                @if($loggedInScheduler->mobile)
                                ...
                                @else
                                    <!-- For regular users, show scheduler selection dropdown -->
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-3">
                                                <label class="control-label form-label">Select Scheduler <span
                                                        class="text-danger">*</span></label>
                                                <select class="form-select" name="scheduler_id" required>
                                                    <option value="">Choose a scheduler...</option>
                                                    @foreach(\App\Models\Scheduler::all() as $scheduler)
                                                        <option value="{{ $scheduler->id }}">{{ $scheduler->name }} - {{ $scheduler->mobile }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="invalid-feedback">Please select a scheduler</div>
                                            </div>
                                        </div>
                                    </div>
                                @endif
...
@section('script-bottom')
    @vite(['resources/js/pages/appointment-index.js'])
    <script>
        // Pass API URL to fetch appointments
        window.appointmentsApiUrl = "{{ route('appointments.json') }}";
